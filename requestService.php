...
<div id="regForm">
  ...
  <div class="tab">address Info:
    <p><input placeholder="Address" oninput="this.className = ''" id="addr" name="address" onchange="getCoodinates()"></p>
    <div id="map"></div>
...
$("#submitBtn").click(function(){
  contact= $("#contact").val();
  console.log(address, lat, lon,image,contact);
})
</script>

<script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCdk0GkRdoCCpgU-T_rBFoU_CFPWB5KnBM&callback=initMap">
</script>
