            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="project-info-box">
                        ...
                        <p><b>Address:</b><?php echo htmlentities($row['address']) ?> <br> <small><a href="direction.php?id=<?php echo htmlentities($row['id']) ?>&lat=<?php echo htmlentities($row['latt']) ?>&long=<?php echo htmlentities($row['lon']) ?>&address=<?php echo htmlentities($row['address']) ?>">View on Map</a></small></p>
                    ...
                    <div class="project-info-box mt-0 mb-0">
                        <p class="mb-0">
                            ...
                            <select class="form-select" id="actionRequest">
                                ...
                                <?php if ($row['status'] == 3) { ?>
                                    <option value="1">Mark PickedUp</option>
                                <?php } ?>
                                <?php if ($row['status'] == 2) { ?>
